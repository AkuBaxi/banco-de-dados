        ...
        <div class="container">
            ...
            <form id="configuracao-form" action="update_user.php" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="cpf" name="cpf" value="<?php echo $_SESSION['user_cpf']; ?>" pattern="\d{3}\.\d{3}\.\d{3}-\d{2}" required>
                </div>
                <div class="form-group">
                    <label for="endereco">Endereço:</label>
                    <input type="text" id="endereco" name="endereco" value="<?php echo $_SESSION['user_endereco']; ?>" required>
                </div>
                <div class="form-group">
